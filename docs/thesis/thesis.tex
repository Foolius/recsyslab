...
\newcommand{\mySupervisor}{Ernesto Diaz-Aviles, M. Sc.\xspace}
...
\usepackage[eulerchapternumbers,listings,%linedheaders,%pdfspacing,
            subfig,beramono,eulermath,dottedtoc,floatperchapter]{classicthesis}
...
\lstdefinestyle{docstring}{%language=Python,
    keywordstyle=\color{RoyalBlue},%\bfseries,
