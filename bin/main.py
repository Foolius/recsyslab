...
r = reader.tabSepReader("rand.data")
...
#a, b = split.splitMatrix(r.getMatrix(), 13508342)
#c, d = split.splitMatrix(a, 13508342)
k = knn.knn(r.getMatrix(), 2)
#kf = open("knn.npz", "wb")
#cPickle.dump(k, kf, -1)
#kf = open("knn.npz", "rb")
#k = cPickle.load(kf)
#kf.close()
#test.hitrate(b, k.getRec, 10)
#test.hitrate(d, k.getRec, 10)
