...
class RankMFX:
    def learnModel(self, n_users, m_items, regU, regI, regJ, learningRate, R, k, epochs, niter):
        ...
        #---
        #This is slower if R is big, i.e., close to the number of users, but for the online approach is faster
        userIds = R.keys()
        ...
        for epoch in xrange(0,epochs):
            ...
            while t <= niter:
                ...
                if t%printDelay == 0:
                    print("Epoch: %i/%i | iteration %i/%i | learning rate=%f | average_loss for the last %i iterations = %f" % \
                          (epoch+1, epochs, t, niter, eta, printDelay, sum_loss/printDelay))
                    sum_loss  = 0.0
        return W,H        
    ...
    def slowlearnModel(self, n_users, m_items, reg_u, reg_i, reg_j, eta0, R, k, epochs, niter):
